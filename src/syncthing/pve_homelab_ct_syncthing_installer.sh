#!/usr/bin/env bash
# ----------------------------------------------------------------------------------
# Filename:     pve_homelab_ct_syncthing_installer.sh
# Description:  This script is for creating a Syncthing CT
# ----------------------------------------------------------------------------------
...
#---- Install Syncthing
section "Install Syncthing software"
...
msg_box "Syncthing CT installation was a success.  The first start-up may take a few seconds so be patient. Web-interface is available on:  
