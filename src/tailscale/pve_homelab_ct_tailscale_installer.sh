#!/usr/bin/env bash
# ----------------------------------------------------------------------------------
# Filename:     pve_homelab_ct_tailscale_installer.sh
# Description:  This script is for creating a Tailscale CT
# ----------------------------------------------------------------------------------
...
#---- Custom CT unprivileged mapping
...
#---- Install Tailscale
section "Install Tailscale software"
...
# Tailscale SW
pct exec $CTID -- bash -c "export REPO_PKG_NAME=$REPO_PKG_NAME APP_USERNAME=$APP_USERNAME APP_GRPNAME=$APP_GRPNAME && /tmp/$GIT_REPO/src/$REPO_PKG_NAME/tailscale_sw.sh"
