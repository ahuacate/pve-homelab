#!/usr/bin/env bash
# ----------------------------------------------------------------------------------
# Filename:     pve_homelab_ct_ddclient_installer.sh
# Description:  Installer script for Proxmox PiHole Server
# ----------------------------------------------------------------------------------
...
#---- Source local Git
# /mnt/pve/nas-01-git/ahuacate/pve-homelab/pve_homelab_ct_ddclient_installer.sh
...
GIT_APP_SCRIPT='pve_homelab_ct_ddclient.sh'
